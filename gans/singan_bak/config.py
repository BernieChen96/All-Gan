...
project_path = base.get_root_path()
...
def get_arguments():
    ...
    parser.add_argument('--DATA_ROOT', help='input image dir', default=os.path.join(project_path, 'data'))
    parser.add_argument('--DATASET', help='input image name',
                        default='SOB_B_A-14-22549AB-40-001.png')
